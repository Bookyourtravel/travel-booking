...
const PACKAGES_DATA: Record<string, PackageItem> = {
  ayodhya: {
    ...
    rating: 4.7,
    images: ["/images/ayodhya1.jpg", "/images/ayodhya2.jpg", "/images/ayodhya4.jpg"],
    badge: "Popular",
    overview:
...
It is one of the twelve Jyotirlinga shrines and a core pilgrimage site for Hindus; the temple complex includes several smaller shrines and historic features such as the Gyanvapi well.`,
        images: ["/images/kashi-temple1.jpg", "/images/kashi-temple2.jpg"],
      },
      {
...
At dusk, the daily Ganga Aarti — a rhythmic, lamp-based ritual accompanied by chants — creates an immersive spiritual experience for visitors.`,
        images: ["/images/dashashwamedh1.jpg", "/images/ganga-aarti1.jpg"],
      },
      {
        slug: "sarnath",
        title: "Sarnath",
...
Visitors can see the archaeological ruins, the Dhamek Stupa, and the Sarnath museum.`,
        images: ["/images/sarnath1.jpg", "/images/sarnath2.jpg"],
      },
      {
        slug: "namo-ghat",
        title: "Namo Ghat",
...
Visitors should be respectful of rituals and the solemn atmosphere at this site.`,
        images: ["/images/manikarnika1.jpg"],
      },
    ],
  },
...
"lucknow-airport": {
    ...
    title: "Varanasi/Lucknow — Airport Pickup & Drop",
    ...
    heroImage: "/images/lucknow-airport.jpg",
    short: "Comfortable sedan / Innova with flight tracking, meet & greet and flexible pickup/drop options between Varanasi and Lucknow.",
    starting: "₹699 (Pickup)",
    duration: "As required",
    highlights: ["Flight tracking", "Meet & greet", "Child seat available", "Fixed fare"],
    rating: 4.6,
    images: ["/images/airport.jpg", "/images/airport2.jpg"],
    overview:
    ...
    attractions: [
      {
        ...
        images: ["/images/airport-meet.jpg"]
      },
      {
        ...
        images: ["/images/flight-track.jpg"]
      }
    ],
  },
  ...
  "ganga-aarti": {
    ...
    heroImage: "/images/ganga-aarti1.jpg",
