...
const PACKAGES_LIST = [
  {
    ...
    duration: "Full day",
    highlights: ["Private car", "Driver guide"],
    rating: 4.7,
    images: ["/images/ayodhya1.webp"],
    badge: "Popular",
  },
  {
    slug: "kashi-darshan",
    ...
    duration: "3–4 hours",
    highlights: ["Ganga Aarti", "Local guide"],
    rating: 4.9,
    images: ["/images/kashi1.webp"],
    badge: "Top Rated",
  },
  {
    ...
    highlights: ["Flight tracking", "Meet & greet"],
    rating: 4.6,
  ...
  },
  {
    ...
    short: "Day trip or overnight packages.",
    starting: "₹2,900 (4 pax)",
    duration: "Overnight",
    highlights: ["Optional hotel"],
    rating: 4.5,
    images: ["/images/prayagraj1.webp"],
  },
  {
    slug: "ganga-aarti",
    title: "Evening Ganga Aarti Special",
    short: "Front-row aarti experience.",
    starting: "₹1,599 (per person)",
    duration: "2 hours",
    highlights: ["Front-row seating"],
    rating: 4.8,
  ...
  },
  {
    ...
    short: "Flexible self-drive cars",
    starting: "₹1,850 / day",
    duration: "Per day",
    highlights: ["Insurance included"],
    rating: 4.4,
    ...
    <div style={{ position: "relative", minHeight: "100vh" }}>
      ...
      <div style={{ textAlign: "center", padding: 40 }}>
        ...
        <p style={{ color: "#6b7280" }}>
          Temple trips, day tours, airport transfers and more.
        </p>
      </div>
